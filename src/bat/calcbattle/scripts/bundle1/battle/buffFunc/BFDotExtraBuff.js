...
exports.BFDotExtraBuff = void 0;
var BuffFunc_1 = require("./BuffFunc");
var BFDotExtraBuff = /** @class */ (function (_super) {
    __extends(BFDotExtraBuff, _super);
    function BFDotExtraBuff() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    BFDotExtraBuff.prototype.buff_dotExtraBuff = function (dotUnit) {
        var owner = this._buff.getOwner();
        var conditions = this._funcParams[0].split("|");
        for (var i = 0; i < conditions.length; i++) {
            var condition = conditions[i].split("_");
            if (condition[0] === "self") {
                if (owner.seq !== dotUnit.seq)
                    return;
            }
        }
        var targets = [];
    ...
    return BFDotExtraBuff;
}(BuffFunc_1.BuffFunc));
exports.BFDotExtraBuff = BFDotExtraBuff;
